...
computeMatrix  --scale-regions  -b 3000 -a 3000 -R genebody.bed -S IPvsINPUT.bw -o matrix.gz  --regionBodyLength 5000  -o matrix.gz --outFileNameMatrix matrix.tab
#Generate Figure 11
 plotHeatmap -m ../matrix.gz --outFileName HEATMAP.png --colorMap RdBu --kmeans 3 --outFileSortedRegions 3sorted_clusters.txt --heatmapWidth 10 --heatmapHeight 10 --plotTitle "H3K27me3 gene body enrichment" --regionsLabel "C1" "C2" "C3"
